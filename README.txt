...
Static repo behind krisyotam.com/share. One TSX file per share,
prerendered to plain HTML, deployed to nginx. No framework.
...
Mirrors krisyotam.com:
  ...
  Colors: 100 Whites / 100 Blacks neutrals + 12 pastel hues x 7 steps.
          Variables in src/styles/theme.css.
  Toggle: .dark class on <html> or prefers-color-scheme: dark as
          no-JS fallback.
...
LAYOUT
  ...
  share/
    ...
    tailwind.config.ts
    tsconfig.json
    shares/                  one file per share
    src/
      index.tsx              index page component
      layout.tsx             ShareLayout wrapping every share
      types.ts               ShareMeta
